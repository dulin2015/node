...
document.write('codebase="officecontrol/OfficeControl.cab#version=5,0,2,2" width="100%" height="100%">   ');
...
document.write('<param name="ProductCaption" value="广东智通人才连锁股份有限公司">  ');
document.write('<param name="ProductKey" value="BB052D0F8674D3DE7DE952EAABE4F15C3AFAA22B"> ');
...
document.write('<object id="TANGER_OCX" type="application/ntko-plug"  codebase="officecontrol/OfficeControl.cab#version=5,0,2,2" width="100%" height="100%" ForOnSaveToURL="OnComplete2" ForOnBeginOpenFromURL="OnComplete" ForOndocumentopened="OnComplete3"');
...
document.write('_ProductCaption="广东智通人才连锁股份有限公司"  ');
document.write('_ProductKey="BB052D0F8674D3DE7DE952EAABE4F15C3AFAA22B" ');
...
document.write('codebase="officecontrol/OfficeControl.cab#version=5,0,2,2" width="100%" height="100%" type="application/ntko-plug" ');
document.write('_IsUseUTF8URL="-1"   ');
document.write('_IsUseUTF8Data="-1"   ');
document.write('_BorderStyle="1"   ');
document.write('_BorderColor="14402205"   ');
